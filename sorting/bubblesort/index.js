...
const { bubbleSort, descendingBubbleSort } = require('./bubblesort');
...
const DESC_BUBBLE_NUMBER_SORTED_LIST = descendingBubbleSort(NUMBER_LIST.slice());

// Sort chars list
const BUBBLE_CHARS_SORTED_LIST = bubbleSort(CHARS_LIST.slice());
const DESC_BUBBLE_CHARS_SORTED_LIST = descendingBubbleSort(CHARS_LIST.slice());

// Sort string list
const BUBBLE_STRING_SORTED_LIST = bubbleSort(STRINGS_LIST.slice());
const DESC_BUBBLE_STRING_SORTED_LIST = descendingBubbleSort(STRINGS_LIST.slice());
